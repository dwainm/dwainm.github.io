...
During 2020, just before an intense hiring spree, I got the opportunity to lead a small team of 3 software engineers. Our primary responsibility was [WooCommerce Payments](https://woocommerce.com/payments/) (alongside 3 other teams). With payments being a business focus, we needed more engineers. And in what felt like no time, a 6 month onboarding rollercoaster season led to the team growing to 8 people!
...
The type of work also changed. I was no longer writing code, but rather, spending a lot of time in google docs, messaging and [P2](https://wordpress.com/p2/) (our replacement for email). I could still help out with code reviews and do minor code changes, but I really struggled to find [uninterrupted time](https://stackoverflow.blog/2018/09/10/developer-flow-state-and-its-impact-on-productivity/) to think deeply about the technical problems. Along with this I had to get used to the constant context switching.
