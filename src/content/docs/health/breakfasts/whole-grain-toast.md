...
- **Savory toast concepts**: Adapted from [How Not to Die Cookbook](https://nutritionfacts.org/recipes/) by Dr. Michael Greger
- **Toast topping principles**: Based on [Forks Over Knives](https://www.forksoverknives.com/) whole foods guidelines
...
- Homemade sourdough (see [bread recipes](../../bread/))
