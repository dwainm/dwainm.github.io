...
![Pancakes](/images/health/pancakes.jpg)

---

## Sources

- **Oat pancake method**: Adapted from [Minimalist Baker](https://minimalistbaker.com) by Dana Shultz
- **Whole wheat base**: Adapted from [Forks Over Knives](https://www.forksoverknives.com/) whole grain principles
- **Oil-free baking**: Techniques from [Engine 2 Diet](https://engine2.com/) by Rip Esselstyn
