...
The Neovim editor was forked from Vim (the code has been copied and is currently being changed into something better or different). Its been around since 2015, so this blog post is late to the party. Many people have already embraced [Neovim](https://neovim.io/).
